...
class CI_Form_validation {
	...
	public function custom_rules($field, $label = '', $error = '',$rule ='')
	{
		$this->_field_data[$field] = array(
			'field'				=> $field,
			'label'				=> $label,
...
{
	$url = $str;	
	$chars ="#^http(s)?://[a-z0-9][a-z0-9\-]+[a-z0-9]\.[a-z0-9-_.]+\.[a-z]{2,4}/[a-z0-9-_.]{2,30}$#i";
	$cnt = substr_count($url, ' ');
	if( ($cnt == 0) && (preg_match($chars, $url))){
		return true;
	} else {
		return false;
	}
