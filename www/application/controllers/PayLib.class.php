...
class payLib{
	 ...
	 */
	public function payLib($type = BUY_NOW, $name='frmPaypal'){
	...
	public function getHtml(){
		...
		$this->html .= "<form name=\"frmpaypal\" action=\"{$url}\" method=\"post\"";
	...
	public function html(){
		$html = $this->getHtml();
		$html .= $this->button;
		$html .= '<input id="pp-cmd" type="hidden" value="_xclick" name="cmd">'."\n</form>";
		return $html;
	}				
}	
/**
