			...
			<div role="toolbar" class="btn-toolbar pad-top">
				<div class="btn-group">
					<a class="btn btn-default btn-sm" href="<?php echo BASE_URL?>editor/raw_media_pull">RAW MEDIA PULL</a>
			       	<a class="btn btn-default btn-sm" href="<?php echo BASE_URL?>editor/raw_media_pull/connect">CONNECT</a>
				    <a class="btn btn-default btn-sm active" href="javascript:void(0);">SUBMIT FINAL PIECE</a>
	...
	$('#add_contributor').click(function(){
		...
		if(username=='')
			...
			else
			{
				...
				$.ajax({
					type: "POST",
					url: "<?php echo BASE_URL;?>editor/raw_media_pull/get_result",
 ...
 <?php $mem_ids=2;?>
		...
		//var values1 = $("input[id='same_user']").map(function(){return $(this).val();}).get();
                    $("#username").autocomplete({
                     source:'<?php echo BASE_URL;?>editor/raw_media_pull/allotment_search/<?php echo $content_details->content_id?>',
                     minLength:1
                    });
                });
</script>
