...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-4">
			...
			<h3 class="less-mar-bottom">SUBMITTED FINAL PIECES  (<?php echo sizeof($content_details) ?>)</h3>
		</div>
		<div class="col-lg-8 col-nd-7 pad-top">
			<div class="row">
				...
				<tbody>
					<?php 
					foreach($content_details as $row) { print_r($content_details);exit;
						$location = $row->city.", ".$row->state.", ".$row->country;
					...
					<tr>
						...
						<td style="text-align:center">
							<a href="<?php echo BASE_URL ?>editor/raw_media_pull/edit_submitted_final_piece?content_key=<?php echo $row->content_key?>"><i class="fa fa-pencil-square-o"></i></a> |
							<a href="<?php echo BASE_URL ?>editor/raw_media_pull/edit_allotment?content_key=<?php echo $row->content_key?>" ><i class="fa fa-sitemap"></i></a>
						</td>
					</tr>
					<?php } ?>
