...
<div class="container">
		...
		<tr>
			...
			<td <?php if($level==1){?>style="color:#fff;background:#357EBD"<?php } ?>>
				<input type="radio" name="level" value="1"   <?php if($level==1){?> checked="checked" <?php } ?>  /> 
			</td>
            <td <?php if($level==2){?>style="color:#fff;background:#357EBD"<?php } ?>>
				<input type="radio"  name="level" value="2" <?php if($level== 2){?>    checked="checked" <?php } ?>/>
			</td>
			<td <?php if($level==3){?>style="background:#357EBD"<?php } ?>>
				<input type="radio" name="level" value="3" <?php if($level==3){?>    checked="checked" <?php } ?>/>
			</td>
			<td <?php if($level==4){?>style="background:#357EBD"<?php } ?>>
				<input type="radio" name="level" value="4" <?php if($level==4){?>   checked="checked" <?php } ?>/>
			</td>
			<td <?php if($level==5){?>style="background:#357EBD"<?php } ?>>
				<input type="radio" name="level" value="5" <?php if($level==5){?>   checked="checked" <?php } ?>/>
