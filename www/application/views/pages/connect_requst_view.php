	...
	<div class="row" >
 		<div class="col-lg-5">
			<div role="toolbar" class="btn-toolbar pad-top">
				<div class="btn-group">
					<a class="btn btn-default btn-sm" href="<?php echo BASE_URL?>editor/raw_media_pull">RAW MEDIA PULL</a>
					<a class="btn btn-default btn-sm active" href="<?php echo BASE_URL?>editor/raw_media_pull/connect">CONNECT</a>
					<a class="btn btn-default btn-sm" href="javascript:void(0);">SUBMIT FINAL PIECE</a>
			...
			<div class="row">
				...
				foreach($member_requests as $row) :		
					...
					if($row->type==1)
					{
						...
						$member_contribution_details = $this->content_model->combox("*","content_id IN ($contents_ids)"); 
					}
					else
						$member_contribution_details = $this->content_model->combox("*","editor='".$row->mem_id."'");
                    ...
                    <a href="<?php echo BASE_URL?>story/details?key=<?php echo $row_contribution_details->content_key ?>" >
            	  	<?php  echo $row_contribution_details->title; ?><br>
                    </a>
					<?php  endforeach;?>
				    </h6>
 				    <hr>	
					...
					<hr>
						...
						<?php */?>
  						...
  						<button class="btn btn-primary btn-sm" name="btnfolio" type="button">View Folio</button>
				...
				endforeach;?>
 				  <form  action="" method="get">
					...
					<div class="row">
 					...
 					<div class="form-group"><input type="text" name="code" value="<?php  echo $zipcode;?>" class="form-control input-sm"                     placeholder="Postal Code" /></div>
