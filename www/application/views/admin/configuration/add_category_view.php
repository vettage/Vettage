<?php   
$category_title 	= ''; if($this->input->post('category_title')!=NULL) $category_title = $this->input->post('category_title');
?>
						...
						<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
							<div class="row-fluid">
 									<div class="control-group <?php echo ((form_error('category_title')!=NULL)) ? 'error' : '' ?>">
										...
										<div class="controls"><input type="text" name="category_title" id="category_title" class="input-xlarge" value="<?php echo $category_title ?>">
 									...
 									<div class="form-actions text-right">
										<input type="submit" class="btn btn-info" value="Add Category" name="sbmt_add_category" /> 
