				...
				<div class="row">
					<div class="span19">
                        ...
                        <div class="control-group <?php echo ((form_error('question')!=NULL)) ? 'error' : '' ?>">
                            ...
                            <div class="controls"><input type="text" name="question" id="question" class="input-xlarge" value="<?php echo ($this->input->post('question')!=NULL) ? $this->input->post('question') : ''?>">
                          ...
                          <div class="control-group <?php echo ((form_error('answer')!=NULL)) ? 'error' : '' ?>">
                            ...
                            <div class="controls">
							<?php $text= ($this->input->post('answer')!=NULL) ? $this->input->post('answer'): '' ; ?>
							<?php 	
								include FCKROOT; 
