...
<body>
	<?php if (isset($_SESSION['permissions'])) $permissions = $_SESSION['permissions']; else $permissions='';?>
	<div id="wrap">
		<div class="navbar navbar-fixed-top">
			...
			<div class="navbar-inner">
				<div class="container">
						...
						<?php } else {   ?>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo BASE_URL?>admin/members/editor_payment">Editor Payment Details</a></li>
								</ul>
							</li>
                            <li >
					...
					<? if(isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in']!=NULL) { ?>
